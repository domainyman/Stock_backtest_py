...
class matplotlib_Canvas():
    ...
    def add_ht_dcperiod(self, i):
        self.data['HT_DCPERIOD'] = self.data['HT_DCPERIOD'].ffill()
    ...
    def add_ht_dchase(self, i):
        self.data['HT_DCPHASE'] = self.data['HT_DCPHASE'].ffill()
    ...
    def add_ht_phasor(self, i):
        self.data['HT_PHASOR_INHPASE'] = self.data['HT_PHASOR_INHPASE'].ffill()
        self.data['HT_PHASOR_QUADRATURE'] = self.data['HT_PHASOR_QUADRATURE'].ffill()
    ...
    def add_ht_sine(self, i):
        self.data['SINE'] = self.data['SINE'].ffill()
        self.data['LEADSINE'] = self.data['LEADSINE'].ffill()
    ...
    def add_macdext(self, i):
        self.data['MACDEXT'] = self.data['MACDEXT'].ffill()
        self.data['MACDEXT_SIGNAL'] = self.data['MACDEXT_SIGNAL'].ffill()
        self.data['MACDEXT_HIST'] = self.data['MACDEXT_HIST'].ffill()
        # 創建 MACD 指標
        positive_color = 'g'
        negative_color = 'r'
        colors = [positive_color if x >=
    ...
    def add_macdfix(self, i):
        self.data['MACDFIX'] = self.data['MACDFIX'].ffill()
        self.data['MACDFIX_SIGNAL'] = self.data['MACDFIX_SIGNAL'].ffill()
        self.data['MACDFIX_HIST'] = self.data['MACDFIX_HIST'].ffill()
        # 創建 MACD 指標
        positive_color = 'g'
        negative_color = 'r'
        colors = [positive_color if x >=
    ...
    def add_stochf(self, i):
        self.data['STOCHF_FASTK'] = self.data['STOCHF_FASTK'].ffill()
        self.data['STOCHF_FASTD'] = self.data['STOCHF_FASTD'].ffill()
    ...
    def add_stochrsi(self, i):
        self.data['STOCHRSI_SLOWK'] = self.data['STOCHRSI_SLOWK'].ffill()
        self.data['STOCHRSI_SLOWD'] = self.data['STOCHRSI_SLOWD'].ffill()
    ...
    def add_bbands(self):
        self.data['BBANDS_UPPERBAND'] = self.data['BBANDS_UPPERBAND'].ffill()
        self.data['BBANDS_MIDDLEBAND'] = self.data['BBANDS_MIDDLEBAND'].ffill()
        self.data['BBANDS_LOWERBAND'] = self.data['BBANDS_LOWERBAND'].ffill()
        # 創建 bbands 指標
