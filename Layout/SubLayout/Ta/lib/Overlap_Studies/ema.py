...
class ema():
    ...
    def Check_Entry(self, testitem):
        ...
        self.p1 = testitem.loc['EMA_parameter_1']
        self.p2 = testitem.loc['EMA_parameter_2']
        self.p3 = testitem.loc['EMA_parameter_3']
        self.p4 = testitem.loc['EMA_parameter_4']
        self.p5 = testitem.loc['EMA_parameter_5']
