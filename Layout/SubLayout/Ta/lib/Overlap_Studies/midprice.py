...
class midprice():
    ...
    def buysignalsetup(self):
        ...
        if 'MIDPRICE' in tech_dict:
            self.data = tech_dict['MIDPRICE']['GOLDEN CROSS']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def sellsignalsetup(self):
        tech_dict = self.getterEntryTechValue()
        if 'MIDPRICE' in tech_dict:
            self.data = tech_dict['MIDPRICE']['Death Cross']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['MIDPRICE'] = self.lineedit.text()
    ...
    def Entry_tool_dicts(self):
        ...
        self.tool_dict['MIDPRICE']['GOLDEN CROSS'] = self.buysignalcb.currentText()
        self.tool_dict['MIDPRICE']['Death Cross'] = self.sellsignalcb.currentText()
        return self.tool_dict
