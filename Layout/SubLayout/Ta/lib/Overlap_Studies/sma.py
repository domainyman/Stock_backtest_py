...
class sma():
    ...
    def Check_Entry(self, testitem):
        ...
        self.p1 = testitem.loc['SMA_parameter_1']
        self.p2 = testitem.loc['SMA_parameter_2']
        self.p3 = testitem.loc['SMA_parameter_3']
        self.p4 = testitem.loc['SMA_parameter_4']
        self.p5 = testitem.loc['SMA_parameter_5']
