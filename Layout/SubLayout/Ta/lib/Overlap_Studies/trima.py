...
class trima():
    ...
    def base(self):
        return {'TRIMA': {'Parameters_1': 10, 'Parameters_2': 20, 'Parameters_3': 50, 'Parameters_4': 100, 'Parameters_5': 150}}
    ...
    def Check_Entry(self, testitem):
        ...
        self.parameters_1_Parameters_2 = self.tech_dict['TRIMA'][
            'Parameters_1 - Parameters_2']['GOLDEN CROSS']
        self.parameters_2_Parameters_3 = self.tech_dict['TRIMA'][
            'Parameters_2 - Parameters_3']['GOLDEN CROSS']
        self.parameters_3_Parameters_4 = self.tech_dict['TRIMA'][
            'Parameters_3 - Parameters_4']['GOLDEN CROSS']
        self.parameters_4_Parameters_5 = self.tech_dict['TRIMA'][
            'Parameters_4 - Parameters_5']['GOLDEN CROSS']
        self.p1 = testitem.loc['TRIMA_parameter_1']
        self.p2 = testitem.loc['TRIMA_parameter_2']
        self.p3 = testitem.loc['TRIMA_parameter_3']
        self.p4 = testitem.loc['TRIMA_parameter_4']
        self.p5 = testitem.loc['TRIMA_parameter_5']
    ...
    def Parameters_1setup(self):
        ...
        if 'TRIMA' in tech_dict:
            self.data = tech_dict['TRIMA']['Parameters_1']
            return self.data
        else:
            self.datadef = 10
            return self.datadef
    ...
    def Parameters_2setup(self):
        tech_dict = self.getterTechValue()
        if 'TRIMA' in tech_dict:
            self.data = tech_dict['TRIMA']['Parameters_2']
            return self.data
        else:
            self.datadef = 20
            return self.datadef
    ...
    def Parameters_3setup(self):
        tech_dict = self.getterTechValue()
        if 'TRIMA' in tech_dict:
            self.data = tech_dict['TRIMA']['Parameters_3']
            return self.data
        else:
            self.datadef = 50
            return self.datadef
    ...
    def Parameters_4setup(self):
        tech_dict = self.getterTechValue()
        if 'TRIMA' in tech_dict:
            self.data = tech_dict['TRIMA']['Parameters_4']
            return self.data
        else:
            self.datadef = 100
            return self.datadef
    ...
    def Parameters_5setup(self):
        tech_dict = self.getterTechValue()
        if 'TRIMA' in tech_dict:
            self.data = tech_dict['TRIMA']['Parameters_5']
            return self.data
        else:
            self.datadef = 150
            return self.datadef
    ...
    def buysignalsetup_1_2(self):
        ...
        if 'TRIMA' in tech_dict:
            self.data = tech_dict['TRIMA']['Parameters_1 - Parameters_2']['GOLDEN CROSS']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def sellsignalsetup_1_2(self):
        tech_dict = self.getterEntryTechValue()
        if 'TRIMA' in tech_dict:
            self.data = tech_dict['TRIMA']['Parameters_1 - Parameters_2']['Death Cross']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def buysignalsetup_2_3(self):
        tech_dict = self.getterEntryTechValue()
        if 'TRIMA' in tech_dict:
            self.data = tech_dict['TRIMA']['Parameters_2 - Parameters_3']['GOLDEN CROSS']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def sellsignalsetup_2_3(self):
        tech_dict = self.getterEntryTechValue()
        if 'TRIMA' in tech_dict:
            self.data = tech_dict['TRIMA']['Parameters_2 - Parameters_3']['Death Cross']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def buysignalsetup_3_4(self):
        tech_dict = self.getterEntryTechValue()
        if 'TRIMA' in tech_dict:
            self.data = tech_dict['TRIMA']['Parameters_3 - Parameters_4']['GOLDEN CROSS']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def sellsignalsetup_3_4(self):
        tech_dict = self.getterEntryTechValue()
        if 'TRIMA' in tech_dict:
            self.data = tech_dict['TRIMA']['Parameters_3 - Parameters_4']['Death Cross']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def buysignalsetup_4_5(self):
        tech_dict = self.getterEntryTechValue()
        if 'TRIMA' in tech_dict:
            self.data = tech_dict['TRIMA']['Parameters_4 - Parameters_5']['GOLDEN CROSS']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def sellsignalsetup_4_5(self):
        tech_dict = self.getterEntryTechValue()
        if 'TRIMA' in tech_dict:
            self.data = tech_dict['TRIMA']['Parameters_4 - Parameters_5']['Death Cross']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['TRIMA'] = {}
        self.tool_dict['TRIMA']['Parameters_1'] = self.parameter_1lineedit.text()
        self.tool_dict['TRIMA']['Parameters_2'] = self.parameter_2lineedit.text()
        self.tool_dict['TRIMA']['Parameters_3'] = self.parameter_3lineedit.text()
        self.tool_dict['TRIMA']['Parameters_4'] = self.parameter_4lineedit.text()
        self.tool_dict['TRIMA']['Parameters_5'] = self.parameter_5lineedit.text()
    ...
    def calculate(self):
        ...
        self.datadb["TRIMA_parameter_1"] = talib.TRIMA(
            self.datadb["Close"], timeperiod=int(self.parameter_1))
        self.datadb["TRIMA_parameter_2"] = talib.TRIMA(
            self.datadb["Close"], timeperiod=int(self.parameter_2))
        self.datadb["TRIMA_parameter_3"] = talib.TRIMA(
            self.datadb["Close"], timeperiod=int(self.parameter_3))
        self.datadb["TRIMA_parameter_4"] = talib.TRIMA(
            self.datadb["Close"], timeperiod=int(self.parameter_4))
        self.datadb["TRIMA_parameter_5"] = talib.TRIMA(
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['TRIMA'] = {}
        self.tool_dict['TRIMA']['Parameters_1 - Parameters_2'] = {}
        self.tool_dict['TRIMA']['Parameters_1 - Parameters_2']['GOLDEN CROSS'] = self.buysignalcb_1_2.currentText()
        self.tool_dict['TRIMA']['Parameters_1 - Parameters_2']['Death Cross'] = self.sellsignalcb_1_2.currentText()
        self.tool_dict['TRIMA']['Parameters_2 - Parameters_3'] = {}
        self.tool_dict['TRIMA']['Parameters_2 - Parameters_3']['GOLDEN CROSS'] = self.buysignalcb_2_3.currentText()
        self.tool_dict['TRIMA']['Parameters_2 - Parameters_3']['Death Cross'] = self.sellsignalcb_2_3.currentText()
        self.tool_dict['TRIMA']['Parameters_3 - Parameters_4'] = {}
        self.tool_dict['TRIMA']['Parameters_3 - Parameters_4']['GOLDEN CROSS'] = self.buysignalcb_3_4.currentText()
        self.tool_dict['TRIMA']['Parameters_3 - Parameters_4']['Death Cross'] = self.sellsignalcb_3_4.currentText()
        self.tool_dict['TRIMA']['Parameters_4 - Parameters_5'] = {}
        self.tool_dict['TRIMA']['Parameters_4 - Parameters_5']['GOLDEN CROSS'] = self.buysignalcb_4_5.currentText()
        self.tool_dict['TRIMA']['Parameters_4 - Parameters_5']['Death Cross'] = self.sellsignalcb_4_5.currentText()
        return self.tool_dict
