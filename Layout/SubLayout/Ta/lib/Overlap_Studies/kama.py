...
class kama():
    ...
    def Check_Entry(self, testitem):
        ...
        self.parameters_1_Parameters_2 = self.tech_dict['KAMA'][
            'Parameters_1 - Parameters_2']['GOLDEN CROSS']
        self.parameters_2_Parameters_3 = self.tech_dict['KAMA'][
            'Parameters_2 - Parameters_3']['GOLDEN CROSS']
        self.parameters_3_Parameters_4 = self.tech_dict['KAMA'][
            'Parameters_3 - Parameters_4']['GOLDEN CROSS']
        self.parameters_4_Parameters_5 = self.tech_dict['KAMA'][
        ...
        if (self.parameters_1_Parameters_2 == 'False' and self.parameters_2_Parameters_3 == 'False' and self.parameters_3_Parameters_4 == 'False' and self.parameters_4_Parameters_5 == 'False'):
            ...
            if (self.parameters_1_Parameters_2 == 'True'):
                self.MACDitem = testitem.loc['KAMA_parameter_1']
                self.MACD_SIGNALitem = testitem.loc['KAMA_parameter_2']
                if float(self.MACDitem) > float(self.MACD_SIGNALitem):
                    return True
                else:
                    return False
            if (self.parameters_2_Parameters_3 == 'True'):
                self.MACDitem = testitem.loc['KAMA_parameter_2']
                self.MACD_SIGNALitem = testitem.loc['KAMA_parameter_3']
                if float(self.MACDitem) > float(self.MACD_SIGNALitem):
                    return True
                else:
                    return False
            if (self.parameters_3_Parameters_4 == 'True'):
                self.MACDitem = testitem.loc['KAMA_parameter_3']
                self.MACD_SIGNALitem = testitem.loc['KAMA_parameter_4']
                if float(self.MACDitem) > float(self.MACD_SIGNALitem):
                    return True
                else:
                    return False
            if (self.parameters_4_Parameters_5 == 'True'):
                self.MACDitem = testitem.loc['KAMA_parameter_4']
                self.MACD_SIGNALitem = testitem.loc['KAMA_parameter_5']
                if float(self.MACDitem) > float(self.MACD_SIGNALitem):
                    return True
                else:
                    return False
    ...
    def buysignalsetup_1_2(self):
        ...
        if 'KAMA' in tech_dict:
            self.data = tech_dict['KAMA']['Parameters_1 - Parameters_2']['GOLDEN CROSS']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def sellsignalsetup_1_2(self):
        tech_dict = self.getterEntryTechValue()
        if 'KAMA' in tech_dict:
            self.data = tech_dict['KAMA']['Parameters_1 - Parameters_2']['Death Cross']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def buysignalsetup_2_3(self):
        tech_dict = self.getterEntryTechValue()
        if 'KAMA' in tech_dict:
            self.data = tech_dict['KAMA']['Parameters_2 - Parameters_3']['GOLDEN CROSS']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def sellsignalsetup_2_3(self):
        tech_dict = self.getterEntryTechValue()
        if 'KAMA' in tech_dict:
            self.data = tech_dict['KAMA']['Parameters_2 - Parameters_3']['Death Cross']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def buysignalsetup_3_4(self):
        tech_dict = self.getterEntryTechValue()
        if 'KAMA' in tech_dict:
            self.data = tech_dict['KAMA']['Parameters_3 - Parameters_4']['GOLDEN CROSS']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def sellsignalsetup_3_4(self):
        tech_dict = self.getterEntryTechValue()
        if 'KAMA' in tech_dict:
            self.data = tech_dict['KAMA']['Parameters_3 - Parameters_4']['Death Cross']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def buysignalsetup_4_5(self):
        tech_dict = self.getterEntryTechValue()
        if 'KAMA' in tech_dict:
            self.data = tech_dict['KAMA']['Parameters_4 - Parameters_5']['GOLDEN CROSS']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def sellsignalsetup_4_5(self):
        tech_dict = self.getterEntryTechValue()
        if 'KAMA' in tech_dict:
            self.data = tech_dict['KAMA']['Parameters_4 - Parameters_5']['Death Cross']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['KAMA'] = {}
        self.tool_dict['KAMA']['Parameters_1'] = self.parameter_1lineedit.text()
        self.tool_dict['KAMA']['Parameters_2'] = self.parameter_2lineedit.text()
        self.tool_dict['KAMA']['Parameters_3'] = self.parameter_3lineedit.text()
        self.tool_dict['KAMA']['Parameters_4'] = self.parameter_4lineedit.text()
        self.tool_dict['KAMA']['Parameters_5'] = self.parameter_5lineedit.text()
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['KAMA'] = {}
        self.tool_dict['KAMA']['Parameters_1 - Parameters_2'] = {}
        self.tool_dict['KAMA']['Parameters_1 - Parameters_2']['GOLDEN CROSS'] = self.buysignalcb_1_2.currentText()
        self.tool_dict['KAMA']['Parameters_1 - Parameters_2']['Death Cross'] = self.sellsignalcb_1_2.currentText()
        self.tool_dict['KAMA']['Parameters_2 - Parameters_3'] = {}
        self.tool_dict['KAMA']['Parameters_2 - Parameters_3']['GOLDEN CROSS'] = self.buysignalcb_2_3.currentText()
        self.tool_dict['KAMA']['Parameters_2 - Parameters_3']['Death Cross'] = self.sellsignalcb_2_3.currentText()
        self.tool_dict['KAMA']['Parameters_3 - Parameters_4'] = {}
        self.tool_dict['KAMA']['Parameters_3 - Parameters_4']['GOLDEN CROSS'] = self.buysignalcb_3_4.currentText()
        self.tool_dict['KAMA']['Parameters_3 - Parameters_4']['Death Cross'] = self.sellsignalcb_3_4.currentText()
        self.tool_dict['KAMA']['Parameters_4 - Parameters_5'] = {}
        self.tool_dict['KAMA']['Parameters_4 - Parameters_5']['GOLDEN CROSS'] = self.buysignalcb_4_5.currentText()
        self.tool_dict['KAMA']['Parameters_4 - Parameters_5']['Death Cross'] = self.sellsignalcb_4_5.currentText()
        return self.tool_dict
