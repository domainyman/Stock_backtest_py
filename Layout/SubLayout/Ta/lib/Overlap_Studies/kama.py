...
class kama():
    ...
    def Check_Entry(self, testitem):
        ...
        self.p1 = testitem.loc['KAMA_parameter_1']
        self.p2 = testitem.loc['KAMA_parameter_2']
        self.p3 = testitem.loc['KAMA_parameter_3']
        self.p4 = testitem.loc['KAMA_parameter_4']
        self.p5 = testitem.loc['KAMA_parameter_5']
