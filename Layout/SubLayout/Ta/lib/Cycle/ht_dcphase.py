...
class ht_dcphase():
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['HT_DCPHASE'] = self.lineedit.text()
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['HT_DCPHASE'] = {}
        self.tool_dict['HT_DCPHASE']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['HT_DCPHASE']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
