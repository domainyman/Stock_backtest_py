...
class ht_dcperiod():
    ...
    def base(self):
        return {'HT_DCPERIOD': 20}

    def entry_exit_base(self):
        self.entryprofo = {'HT_DCPERIOD': {'HIGH': 35, 'LOW': 20}}
        return self.entryprofo

    def highsetup(self):
        tech_dict = self.getterEntryTechValue()
        if 'HT_DCPERIOD' in tech_dict:
            self.data = tech_dict['HT_DCPERIOD']['HIGH']
            return self.data
        else:
            self.datadef = 35
            return self.datadef
    ...
    def lowsetup(self):
        tech_dict = self.getterEntryTechValue()
        if 'HT_DCPERIOD' in tech_dict:
            self.data = tech_dict['HT_DCPERIOD']['LOW']
            return self.data
        else:
            self.datadef = 20
            return self.datadef
    ...
    def setup(self):
        ...
        if 'HT_DCPERIOD' in tech_dict:
            self.data = tech_dict['HT_DCPERIOD']
            return self.data
        else:
            self.datadef = 20
            return self.datadef
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['HT_DCPERIOD'] = self.lineedit.text()
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['HT_DCPERIOD'] = {}
        self.tool_dict['HT_DCPERIOD']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['HT_DCPERIOD']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
