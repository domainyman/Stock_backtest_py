...
class ht_phasor():
    ...
    def buysignalsetup(self):
        ...
        if 'HT_PHASOR' in tech_dict:
            self.data = tech_dict['HT_PHASOR']['GOLDEN CROSS']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def sellsignalsetup(self):
        tech_dict = self.getterEntryTechValue()
        if 'HT_PHASOR' in tech_dict:
            self.data = tech_dict['HT_PHASOR']['Death Cross']
            return self.data
        else:
            self.datadef = 'True'
            return self.datadef
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['HT_PHASOR'] = self.lineedit.text()
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['HT_PHASOR'] = {}
        self.tool_dict['HT_PHASOR']['GOLDEN CROSS'] = self.buysignalcb.currentText()
        self.tool_dict['HT_PHASOR']['Death Cross'] = self.sellsignalcb.currentText()
        return self.tool_dict
