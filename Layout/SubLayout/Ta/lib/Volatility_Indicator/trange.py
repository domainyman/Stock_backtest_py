...
class trange():
    ...
    def Check_Entry(self, testitem):
        ...
        self.item = testitem.loc['TRANGE']
        self.entryba = self.tech_dict['TRANGE']['LOW']
    ...
    def Check_Exit(self, testitem):
        self.tech_dict = self.getterEntryTechValue()
        self.item = testitem.loc['TRANGE']
        self.entryba = self.tech_dict['TRANGE']['HIGH']
        if (float(self.item) > float(self.entryba)):
            return True
        else:
            return False
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['TRANGE'] = self.lineedit.text()
    ...
    def calculate(self):
        ...
        self.datadb["TRANGE"] = talib.TRANGE(
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['TRANGE'] = {}
        self.tool_dict['TRANGE']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['TRANGE']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
