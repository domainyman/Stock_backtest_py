...
class natr():
    ...
    def entry_exit_base(self):
        self.entryprofo = {'NATR': {'HIGH': '4', 'LOW': '2'}}
        return self.entryprofo

    def Check_Entry(self, testitem):
        self.tech_dict = self.getterEntryTechValue()
        self.item = testitem.loc['NATR']
        self.entryba = self.tech_dict['NATR']['HIGH']
    ...
    def Check_Exit(self, testitem):
        self.tech_dict = self.getterEntryTechValue()
        self.item = testitem.loc['NATR']
        self.entryba = self.tech_dict['NATR']['LOW']
        if (float(self.item) <= float(self.entryba)):
            return True
        else:
            return False
    ...
    def setup(self):
        ...
        if 'NATR' in tech_dict:
            self.data = tech_dict['NATR']
            return self.data
        else:
            self.datadef = '14'
            return self.datadef
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['NATR'] = self.lineedit.text()
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['NATR'] = {}
        self.tool_dict['NATR']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['NATR']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
