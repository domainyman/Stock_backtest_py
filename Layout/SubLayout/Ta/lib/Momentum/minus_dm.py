...
class minusdm():
    ...
    def entry_exit_base(self):
        self.entryprofo = {'MINUS_DM': {'HIGH': 100, 'LOW': 0}}
    ...
    def setup(self):
        ...
        if 'MINUS_DM' in tech_dict:
            self.data = tech_dict['MINUS_DM']
            return self.data
        else:
            self.datadef = 14
            return self.datadef
    ...
    def highsetup(self):
        ...
        if 'MINUS_DM' in tech_dict:
            self.data = tech_dict['MINUS_DM']['HIGH']
            return self.data
        else:
            self.datadef = 100
            return self.datadef
    ...
    def lowsetup(self):
        tech_dict = self.getterEntryTechValue()
        if 'MINUS_DM' in tech_dict:
            self.data = tech_dict['MINUS_DM']['LOW']
            return self.data
        else:
            self.datadef = 0
            return self.datadef
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['MINUS_DM'] = self.lineedit.text()
    ...
    def calculate(self):
        ...
        self.datadb["MINUS_DM"] = talib.MINUS_DM(
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['MINUS_DM'] = {}
        self.tool_dict['MINUS_DM']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['MINUS_DM']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
