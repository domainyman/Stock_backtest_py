...
class plusdi():
    ...
    def entry_exit_base(self):
        self.entryprofo = {'PLUS_DI': {'HIGH': 100, 'LOW': 0}}
    ...
    def setup(self):
        ...
        if 'PLUS_DI' in tech_dict:
            self.data = tech_dict['PLUS_DI']
            return self.data
        else:
            self.datadef = 14
            return self.datadef
    ...
    def highsetup(self):
        ...
        if 'PLUS_DI' in tech_dict:
            self.data = tech_dict['PLUS_DI']['HIGH']
            return self.data
        else:
            self.datadef = 100
            return self.datadef
    ...
    def lowsetup(self):
        tech_dict = self.getterEntryTechValue()
        if 'PLUS_DI' in tech_dict:
            self.data = tech_dict['PLUS_DI']['LOW']
            return self.data
        else:
            self.datadef = 0
            return self.datadef
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['PLUS_DI'] = self.lineedit.text()
    ...
    def calculate(self):
        ...
        self.datadb["PLUS_DI"] = talib.PLUS_DI(
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['PLUS_DI'] = {}
        self.tool_dict['PLUS_DI']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['PLUS_DI']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
