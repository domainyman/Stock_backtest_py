...
class willr():
    ...
    def entry_exit_base(self):
        self.entryprofo = {'WILLR': {'HIGH': '-20', 'LOW': '-80'}}
    ...
    def setup(self):
        ...
        if 'WILLR' in tech_dict:
            self.data = tech_dict['WILLR']
            return self.data
        else:
            self.datadef = '14'
            return self.datadef
    ...
    def highsetup(self):
        ...
        if 'WILLR' in tech_dict:
            self.data = tech_dict['WILLR']['HIGH']
            return self.data
        else:
            self.datadef = '-20'
            return self.datadef
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['WILLR'] = self.lineedit.text()
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['WILLR'] = {}
        self.tool_dict['WILLR']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['WILLR']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
