...
class ppo():
    ...
    def base(self):
        return {'PPO': {'fastperiod': 12, 'slowperiod': 26, 'matype': 0}}
    
    def entry_exit_base(self):
        self.entryprofo = {'PPO': {'HIGH': 5, 'LOW': -5}}
    ...
    def fastperiodsetup(self):
        ...
        if 'PPO' in tech_dict:
            self.data = tech_dict['PPO']['fastperiod']
            return self.data
        else:
            self.datadef = 12
            return self.datadef
    ...
    def slowperiodsetup(self):
        tech_dict = self.getterTechValue()
        if 'PPO' in tech_dict:
            self.data = tech_dict['PPO']['slowperiod']
            return self.data
        else:
            self.datadef = 26
            return self.datadef
    ...
    def matypesetup(self):
        tech_dict = self.getterTechValue()
        if 'PPO' in tech_dict:
            self.data = tech_dict['PPO']['matype']
            return self.data
        else:
            self.datadef = 0
            return self.datadef
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['PPO'] = {}
        self.tool_dict['PPO']['fastperiod'] = self.fastperiodlineedit.text()
        self.tool_dict['PPO']['slowperiod'] = self.slowperiodlineedit.text()
        self.tool_dict['PPO']['matype'] = self.matypelineedit.text()
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['PPO'] = {}
        self.tool_dict['PPO']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['PPO']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
