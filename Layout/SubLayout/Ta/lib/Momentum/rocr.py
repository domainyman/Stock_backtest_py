...
class rocr():
    ...
    def entry_exit_base(self):
        self.entryprofo = {'ROCR': {'HIGH': 2, 'LOW': 0}}
    ...
    def setup(self):
        ...
        if 'ROCR' in tech_dict:
            self.data = tech_dict['ROCR']
            return self.data
        else:
            self.datadef = 10
            return self.datadef
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['ROCR'] = self.lineedit.text()
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['ROCR'] = {}
        self.tool_dict['ROCR']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['ROCR']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
