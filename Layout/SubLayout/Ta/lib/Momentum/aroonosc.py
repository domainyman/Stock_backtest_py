...
class aroonosc():
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['AROONOSC'] = self.lineedit.text()
    ...
    def calculate(self):
        ...
        self.datadb["AROONOSC"] = talib.AROONOSC(
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['AROONOSC'] = {}
        self.tool_dict['AROONOSC']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['AROONOSC']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
