...
class plusdm():
    ...
    def entry_exit_base(self):
        self.entryprofo = {'PLUS_DM': {'HIGH': 50, 'LOW': 0}}
        return self.entryprofo
    
    def Check_Entry(self, testitem):
        self.tech_dict = self.getterEntryTechValue()
        self.item = testitem.loc['PLUS_DM']
        self.entryba = self.tech_dict['PLUS_DM']['LOW']
    ...
    def Check_Exit(self, testitem):
        self.tech_dict = self.getterEntryTechValue()
        self.item = testitem.loc['PLUS_DM']
        self.entryba = self.tech_dict['PLUS_DM']['HIGH']
        if (float(self.item) >= float(self.entryba)):
            return True
        else:
            return False
    ...
    def setup(self):
        ...
        if 'PLUS_DM' in tech_dict:
            self.data = tech_dict['PLUS_DM']
            return self.data
        else:
            self.datadef = 14
            return self.datadef
    ...
    def highsetup(self):
        ...
        if 'PLUS_DM' in tech_dict:
            self.data = tech_dict['PLUS_DM']['HIGH']
            return self.data
        else:
            self.datadef = 50
            return self.datadef
    ...
    def lowsetup(self):
        tech_dict = self.getterEntryTechValue()
        if 'PLUS_DM' in tech_dict:
            self.data = tech_dict['PLUS_DM']['LOW']
            return self.data
        else:
            self.datadef = 0
            return self.datadef
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['PLUS_DM'] = self.lineedit.text()
    ...
    def calculate(self):
        ...
        self.datadb["PLUS_DM"] = talib.PLUS_DM(
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['PLUS_DM'] = {}
        self.tool_dict['PLUS_DM']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['PLUS_DM']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
