...
class bop():
    ...
    def Check_Entry(self, testitem):
        ...
        self.item = testitem.loc['BOP']
        self.entryba = self.tech_dict['BOP']['LOW']
    ...
    def Check_Exit(self, testitem):
        self.tech_dict = self.getterEntryTechValue()
        self.item = testitem.loc['BOP']
        self.entryba = self.tech_dict['BOP']['HIGH']
        if (float(self.item) > float(self.entryba)):
            return True
        else:
            return False
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['BOP'] = self.lineedit.text()
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['BOP'] = {}
        self.tool_dict['BOP']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['BOP']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
