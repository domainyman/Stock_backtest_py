...
class cci():
    ...
    def entry_exit_base(self):
        self.entryprofo = {'CCI': {'HIGH': 100, 'LOW': -100}}
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['CCI'] = self.lineedit.text()
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['CCI'] = {}
        self.tool_dict['CCI']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['CCI']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
