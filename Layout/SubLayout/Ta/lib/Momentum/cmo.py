...
class cmo():
    ...
    def Check_Entry(self, testitem):
        ...
        self.entryba = self.tech_dict['CMO']['LOW']
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['CMO'] = self.lineedit.text()
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['CMO'] = {}
        self.tool_dict['CMO']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['CMO']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
