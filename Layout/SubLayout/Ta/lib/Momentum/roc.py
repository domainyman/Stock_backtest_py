...
class roc():
    ...
    def Check_Entry(self, testitem):
        ...
        self.item = testitem.loc['ROC']
        self.entryba = self.tech_dict['ROC']['LOW']
    ...
    def Check_Exit(self, testitem):
        self.tech_dict = self.getterEntryTechValue()
        self.item = testitem.loc['ROC']
        self.entryba = self.tech_dict['ROC']['HIGH']
        if (float(self.item) > float(self.entryba)):
            return True
        else:
            return False
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['ROC'] = self.lineedit.text()
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['ROC'] = {}
        self.tool_dict['ROC']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['ROC']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
