...
class adx():
    ...
    def entry_exit_base(self):
        self.entryprofo = {'ADX': {'HIGH': 30, 'LOW': 15}}
        return self.entryprofo

    def setup(self):
        tech_dict = self.getterTechValue()
        if 'ADX' in tech_dict:
            self.data = tech_dict['ADX']
            return self.data
        else:
            self.datadef = 14
            return self.datadef
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['ADX'] = self.lineedit.text()
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['ADX'] = {}
        self.tool_dict['ADX']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['ADX']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
