...
class minusdi():
    ...
    def entry_exit_base(self):
        self.entryprofo = {'MINUS_DI': {'HIGH': 100, 'LOW': 0}}
    ...
    def setup(self):
        ...
        if 'MINUS_DI' in tech_dict:
            self.data = tech_dict['MINUS_DI']
            return self.data
        else:
            self.datadef = 14
            return self.datadef
    ...
    def highsetup(self):
        ...
        if 'MINUS_DI' in tech_dict:
            self.data = tech_dict['MINUS_DI']['HIGH']
            return self.data
        else:
            self.datadef = 100
            return self.datadef
    ...
    def lowsetup(self):
        tech_dict = self.getterEntryTechValue()
        if 'MINUS_DI' in tech_dict:
            self.data = tech_dict['MINUS_DI']['LOW']
            return self.data
        else:
            self.datadef = 0
            return self.datadef
    ...
    def tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['MINUS_DI'] = self.lineedit.text()
    ...
    def calculate(self):
        ...
        self.datadb["MINUS_DI"] = talib.MINUS_DI(
    ...
    def Entry_tool_dicts(self):
        self.tool_dict = {}
        self.tool_dict['MINUS_DI'] = {}
        self.tool_dict['MINUS_DI']['HIGH'] = self.EntryHighlineedit.text()
        self.tool_dict['MINUS_DI']['LOW'] = self.EntryLowlineedit.text()
        return self.tool_dict
